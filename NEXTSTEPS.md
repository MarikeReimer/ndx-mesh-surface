# Next Steps for ndx-mesh-surface Extension for NWB:N

## Creating Your Extension

1. In a terminal, change directory into the new ndx-mesh-surface directory.
...
4. Modify `src/spec/create_extension_spec.py` to define your extension.
    ...
    - If you want to create any custom classes for interacting with the extension,
      ...
      - If present, the `src/pynwb` folder MUST contain the following:
        - `ndx-mesh-surface` - Folder with the sources of the NWB extension
        - `ndx-mesh-surface/__init__.py` - Python file that may be empty
...
`spec/ndx-mesh-surface.namespace.yaml` and
`spec/ndx-mesh-surface.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-mesh-surface
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/MarikeReimer/ndx-mesh-surface/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-mesh-surface/0.1.0
...
`staged-extensions/ndx-mesh-surface`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-mesh-surface
    ```

13. Edit `staged-extensions/ndx-mesh-surface/ndx-meta.yaml`
...
version: 0.1.0
src: https://github.com/MarikeReimer/ndx-mesh-surface
pip: https://pypi.org/project/ndx-mesh-surface/
license: BSD 3-Clause
maintainers:
  - MarikeReimer
```

14. Edit `staged-extensions/ndx-mesh-surface/README.md`
to add information about your extension. You may copy it from
`ndx-mesh-surface/README.md`.

  ```bash
cp ndx-mesh-surface/README.md staged-extensions/ndx-mesh-surface/README.md
```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-mesh-surface
git commit -m "Add new catalog entry for ndx-mesh-surface" .
git push
```
...
ndx-mesh-surface-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-mesh-surface GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-mesh-surface-feedstock repository on GitHub.
